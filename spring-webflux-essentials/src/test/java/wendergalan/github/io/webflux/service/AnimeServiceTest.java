package wendergalan.github.io.webflux.service;
...
class AnimeServiceTest {
    ...
    @Test
    @DisplayName("save creates and anime when successful")
    ...
    @Test
    @DisplayName("saveAll returns mono error when one of the object in the list contains null or empty names.")
    ...
    @Test
    @DisplayName("delete removes Mono error when anime does not exist")
