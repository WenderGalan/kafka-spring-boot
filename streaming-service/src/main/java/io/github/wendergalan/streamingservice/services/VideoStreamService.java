package io.github.wendergalan.streamingservice.services;
...
import static io.github.wendergalan.streamingservice.Constants.*;
...
public class VideoStreamService {
    ...
    private String getFilePath() {
        URL url = this.getClass().getResource("/mp4");
